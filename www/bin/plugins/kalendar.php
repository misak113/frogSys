	...
	*/
	...
	function writeKalendar($id, $start, $stop, $mesic, $rok, $editable) {
		...
		<table class="kalendar">
			<tr>
				<td> <a href="javascript: var k_id = \''.$id.'\'; var a = postAjaxRequest(\'/bin/plugins/kalendar.php\', \'echo=true&k_id='.$id.'&k_start=\'+document.getElementById(\'plan_akci_kdy_'.$id.'\').value+\'&k_stop=\'+document.getElementById(\'plan_akci_do_'.$id.'\').value+\'&k_mesic='.$mesicpred.'&k_rok='.$rokpred.'&k_editable='.$editable.'\', zobrazNovyMesic);">&lt;</a> </td>
				<td colspan="6"> '.$mesice[$mesic].' &nbsp; '.$mesic.'. '.$rok.' </td>
				<td> <a href="javascript: var k_id = \''.$id.'\'; var a = postAjaxRequest(\'/bin/plugins/kalendar.php\', \'echo=true&k_id='.$id.'&k_start=\'+document.getElementById(\'plan_akci_kdy_'.$id.'\').value+\'&k_stop=\'+document.getElementById(\'plan_akci_do_'.$id.'\').value+\'&k_mesic='.$mesicpo.'&k_rok='.$rokpo.'&k_editable='.$editable.'\', zobrazNovyMesic);">&gt;</a> </td>
			</tr>
			<tr>
				<td>  </td>
				<td> Po </td>
