<?php
			...
			if ($_POST['action'] == "edit_form") {
				...
				<table class="edit_table">
					...
					<tr>
						<td>odkaz <img src="/images/icons/info.png" width="10" height="10" alt="info" onmouseout="hideInfo();" onmouseover="showInfo(event, 'název důležitý pro stromovou struktůru v odkazu stránky (www.web.cz/polozka-menu/)');">:</td>
