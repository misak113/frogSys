...
function addAkce(id) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=add&parent="+id, editPlan_akci)) {
...
function editPlan_akci(id) {
	id_plan_akci_del = id;
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=get_id_part&id="+id, editPlan_akci2)) {
		//pokud nefunguje ajax
		return;
	}
}
function editPlan_akci2(str) {
	...
	aktualSubPage = str;
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=edit&id="+id_plan_akci_del, createWindow)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function savePlan_akci(id) {
	...
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=save&id="+id+"&name="+name+"&kdy="+kdy+"&kde="+kde+"&co="+co+"&text="+text+"&do="+dokdy+"&limit_lidi="+limit_lidi+"&cena="+cena, partRefresh)) {
		//pokud nefunguje ajax
		return;
	}
	zavriWindow();
...
function deletePlan_akci(id) {
	id_plan_akci_del = id;
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=get_id_part&id="+id, deletePlan_akci2)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function deletePlan_akci3(id) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=delete&id="+id, partRefresh)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function usersPlan_akci(id) {
	id_plan_akci_del = id;
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=users&id="+id, createWindow)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function deleteUser2(id) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=delete_user&id="+id, obnovUsery)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function cashUser(id) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=cash_user&id="+id, obnovUsery)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function obnovUsery(text) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=users&id="+id_plan_akci_del, obnovUsery2)) {
		//pokud nefunguje ajax
		return;
	}
	createAlert(text);
...
function mailUser(id) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=mail_user&id="+id, obnovUsery)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function sendCollectiveMail(id) {
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=collective_mail&id="+id, createWindow)) {
		//pokud nefunguje ajax
		return;
	}
}
...
function sendCollectiveMail2(id) {
	...
	zavriWindow();
	if (!postAjaxRequest("/bin/ajax/edit.php", "predmet=plan_akci&action=send_collective_mail&id="+id+"&predmet_mail="+predmet+"&text="+text, createAlert)) {
		//pokud nefunguje ajax
		return;
	}
}
